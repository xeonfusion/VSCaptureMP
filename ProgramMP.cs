...
namespace VSCaptureMP
{
    public class ProgramMP
    {
        ...
        {
            Console.WriteLine("VitalSignsCaptureMP (C)2017-24 John George K.");
        ...
        public static void ConnectviaLAN(string[] args)
        {
            ...
            else
            {
                ...
                Console.WriteLine("11. EEG/BIS, EEG L, EEG R, ECG II");
                Console.WriteLine("12. All");

                Console.WriteLine();
                Console.WriteLine("Selecting all waves can lead to data loss due to bandwidth issues");
                Console.Write("Choose Waveform data export priority option (0-12):");
